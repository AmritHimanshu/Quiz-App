      ...
      <div className='flex items-center justify-center'>
        <div className='w-[70%] m-auto p-5 bg-[#9D00FF]/20 flex flex-col items-center justify-center space-y-5 rounded-md'>
          ...
          <div className='w-full space-y-5'>
            <div className='bg-white text-black p-2 rounded-md space-x-2'><span className='py-1 px-2 rounded-full bg-[#1A1A1A] text-white text-xs'>1</span><span>{quizData.questions[0].options[0].option}</span></div>
            <div className='bg-white text-black p-2 rounded-md space-x-2'><span className='py-1 px-2 rounded-full bg-[#1A1A1A] text-white text-xs'>2</span><span>{quizData.questions[0].options[1].option}</span></div>
