          ...
          <div>
            {currentQuestionIndex < questions.length - 1 && userAnswers[currentQuestionIndex] && isAnswered && (
              <button
                ...
                className="w-full bg-[#39FF14] text-black font-bold py-2 rounded-full mt-3 animate-pulse hover:animate-none hover:drop-shadow-[0_0_15px_rgba(0,255,255,0.3)] transition duration-300"
              >
                Next Question
              </button>
            )}
