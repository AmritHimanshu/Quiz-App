    ...
    <div>
      ...
      <div className='flex items-center justify-center h-[calc(100vh-90px)]'>
        <div className='w-[500px] m-auto flex flex-col items-center py-3 space-y-5'>
          ...
          <button className='p-2 bg-[#39FF14] text-black font-bold w-full rounded-full cursor-pointer hover:drop-shadow-[0_0_15px_rgba(0,255,255,0.3)] duration-300'>Play</button>
        </div>
      </div>
    </div>
  );
